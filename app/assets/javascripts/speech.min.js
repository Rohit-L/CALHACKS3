...
(function (Bing) {
    ...
    var Speech = (function () {
        ...
        Speech.prototype.start = function () {
            ...
            if (this.isMicSource) {
                ...
                (navigator).getUserMedia({
            	    ...
            	    _this.speechEvents = hark(stream, {});
				    ...
				    _this.speechEvents.on('volume_change', function(vol, threshold) {
        ...
        Speech.prototype.stop = function () {
            this.speechEvents.stop(); // Hark stop
    ...
    var HttpClient = (function () {
        ...
        HttpClient.prototype.connect = function (destination, output, input) {
            ...
            if (this.preferences.luisAppId && this.preferences.luisSubscriptionId) {
                window.luis = new LuisClient(this.preferences);
            }
            this.queue = [];
        ...
        HttpClient.prototype.send = function (luis) {
                ...
                request.onload = function () {
                    if (request.readyState == 4 && request.status !== 200) {
                        ...
                        if (result.header.status === HTTPResultStatus.ERROR) {
                            ...
                            _this.dispatchResult(result, luis);
                        }
                    }
                };
        ...
        HttpClient.prototype.dispatchResult = function (result, luis) {
            return;
            var _this = this;
            var reco;
            ...
            if (luis != false && this.luis && this.onintent) {
